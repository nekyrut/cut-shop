...
<head>
    ...
    <link rel="mask-icon" href="{{asset('/images/safari-pinned-tab.svg')}}" color="#1E1F43">
            ...
            <div class="header-actions flex items-center gap-3 md:gap-5">
                ...
                <div x-data="{dropdownProfile: false}" class="profile relative">
                    <button @click="dropdownProfile = ! dropdownProfile"
                        ...
                        <img src="{{asset('/images/avatar.jpg')}}" class="shrink-0 w-7 md:w-9 h-7 md:h-9 rounded-full"
                             alt="Данил Шуцкий">
                    ...
                    >
                        ...
                        <div class="flex items-center mt-3">
                            <img src="{{asset('/images/avatar.jpg')}}" class="w-11 h-11 rounded-full"
                                 alt="Данил Шуцкий">
